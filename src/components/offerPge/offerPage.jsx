...
import {fetchCommentList, fetchNearList} from "../../store/apiActions";
import NearPlaceList from "../nearPlaceLIst/nearPlaceList";
import Map from "../map/map";
import {TYPE__OF__COMPONENT} from "../../constant";
import {sortRevievsFromFresh} from "../../mainLogic";
import {formatCommentDate} from "../../mainLogic";
        ...
        <main className="page__main page__main--property">
          <section className="property">
            ...
            <section className="property__map map">
              <Map coords={offerExact.coords} type={TYPE__OF__COMPONENT.OFFER}/>
            </section>
          </section>
